							...
							<div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <label class="form-label">Ph1/PH2</label>
                                        <input type="text" wire:model="addMesure.Ph1_PH2" class="form-control @error('addMesure.Ph1_PH2') is-invalid @enderror" placeholder="Ph1/PH2" required="required">
                                        @error("addMesure.Ph1_PH2")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    </div>
                                    ...
                                    <label class="form-label">Ph1/PH3</label>
                                        <input type="text" wire:model="addMesure.Ph1_PH3" class="form-control @error('addMesure.Ph1_PH3') is-invalid @enderror" placeholder="Ph1/PH3" required="required">
                                        @error("addMesure.Ph1_PH3")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    </div>
                                    ...
                                    <label class="form-label">Ph2/PH3</label>
                                        <input type="text" wire:model="addMesure.Ph2_PH3" class="form-control @error('addMesure.Ph2_PH3') is-invalid @enderror" placeholder="Ph2/PH3" required="required">
                                        @error("addMesure.Ph2_PH3")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <label class="form-label">Ph1/m</label>
                                        <input type="text" wire:model="addMesure.Ph1_m" class="form-control @error('addMesure.Ph1_m') is-invalid @enderror" placeholder="Ph1/m" required="required">
                                        @error("addMesure.Ph1_m")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    </div>
                                    ...
                                    <label class="form-label">Ph2/m</label>
                                        <input type="text" wire:model="addMesure.Ph2_m" class="form-control @error('addMesure.Ph2_m') is-invalid @enderror" placeholder="Ph2/m" required="required">
                                        @error("addMesure.Ph2_m")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    </div>
                                    ...
                                    <label class="form-label">Ph3/m</label>
                                        <input type="text" wire:model="addMesure.Ph3_m" class="form-control @error('addMesure.Ph3_m') is-invalid @enderror" placeholder="Ph3/m" required="required">
                                        @error("addMesure.Ph3_m")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    </div>
                                    ...
                                    <label class="form-label">X1/X2</label>
                                        <input type="text" wire:model="addMesure.X1_X2" class="form-control @error('addMesure.X1_X2') is-invalid @enderror" placeholder="X1/X2" required="required">
                                        @error("addMesure.X1_X2")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    </div>
                                    ...
                                    <label class="form-label">Y1/Y2</label>
                                        <input type="text" wire:model="addMesure.Y1_Y2" class="form-control @error('addMesure.Y1_Y2') is-invalid @enderror" placeholder="Y1/Y2" required="required">
                                        @error("addMesure.Y1_Y2")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    </div>
                                    ...
                                    <label class="form-label">Z1/Z2</label>
                                        <input type="text" wire:model="addMesure.Z1_Z2" class="form-control @error('addMesure.Z1_Z2') is-invalid @enderror" placeholder="Z1/Z2" required="required">
                                        @error("addMesure.Z1_Z2")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    </div>
