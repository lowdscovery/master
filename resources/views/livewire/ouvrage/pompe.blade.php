...
<div class="modal-header bg-primary text-white">
      ...
      <div class="d-flex my-4 bg-gray-light p-2">
          ...
          <div class="d-flex my-4 bg-gray-light p-2">
              ...
              <button class="btn btn-success mr-2" wire:click="editModalPompe()">Ajouter</button>
              <button type="button" class="btn btn-secondary" data-dismiss="modal" wire.click="">Close</button>
               </div>
      @else
       
      
      <button class="btn btn-success mb-4" wire:click="showInput()">Ajout</button> 
        ...
        @forelse($pompes as $pompe) 
                <tr>
                    ...
                    <td class="text-center" style="width:20%;">
                        <button class="btn btn-link" wire:click="editModal({{$pompe->id}})"> <i class="far fa-edit"></i> </button>  
                        @can("delete",$pompe)
                        <button class="btn btn-link text-danger" wire:click="confirmDeleteModal({{$pompe->id}})"> <i class="far fa-trash-alt"></i> </button>     
                        @endcan
                    </td>
                </tr>
                @empty
